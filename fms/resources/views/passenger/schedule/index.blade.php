...
<div>
    ...
    <p class="font-body-md text-body-md text-on-surface-variant mb-md">Active flight schedule manifest, updated live by our operations team.</p>
        ...
        <table class="w-full text-left">
            ...
            <tbody class="font-data-tabular text-data-tabular">
                ...
                <tr class="zebra-row">
                    ...
                    <td class="p-sm border-b border-outline-variant/20">{{ $flight->departure_time->format('M d, g:i A') }}</td>
                    <td class="p-sm border-b border-outline-variant/20">{{ $flight->arrival_time->format('M d, g:i A') }}</td>
                ...
                @empty
                <tr><td colspan="6" class="p-md text-center text-on-surface-variant">No active schedules at this time</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
