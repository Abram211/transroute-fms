...
<div class="bg-white rounded-xl border border-outline-variant/30 overflow-hidden">
    <div class="p-md border-b border-outline-variant/30 flex items-center justify-between">
        ...
        <a href="{{ route('admin.flights.index') }}" class="font-label-caps text-label-caps text-secondary hover:underline">View Schedule →</a>
    </div>
    <table class="w-full text-left">
        ...
        <tbody class="font-data-tabular text-data-tabular">
            ...
            @empty
            <tr><td colspan="5" class="p-md text-center text-on-surface-variant">No flights yet</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
