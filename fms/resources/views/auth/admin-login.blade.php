...
<body
    style="background:linear-gradient(135deg,#001f3c,#151f2f);min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;font-family:Inter,sans-serif">
    <div style="width:100%;max-width:28rem">
        ...
        <div
            ...
            <h3
                style="font-family:'Hanken Grotesk',sans-serif;font-size:1.5rem;font-weight:600;color:#001f3c;margin-bottom:.5rem;text-align:center">
                Admin Sign In</h3>
            <p style="font-size:.875rem;color:#42474f;margin-bottom:1.5rem;text-align:center">Restricted access —
            ...
            <form method="POST" action="{{ route('admin.login') }}"
                ...
                <button type="submit"
                    style="width:100%;background:#fe6b00;color:#572000;padding:1rem;border-radius:.5rem;font-weight:700;font-size:12px;letter-spacing:.05em;text-transform:uppercase;border:none;cursor:pointer">
                    Access Admin Console
                </button>
            </form>
            <p style="margin-top:1.5rem;font-size:.75rem;color:#94a3b8;text-align:center"><a href="{{ route('login') }}"
                    style="color:#001f3c">← Passenger Login</a></p>
        </div>
    </div>
</body>
